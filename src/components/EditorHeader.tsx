...
import { ProjectSettingsPopup } from "@/components/editor/project-pop-up";
...
interface EditorHeaderProps {
  ...
  currentProject?: any;
  onNewProject?: () => void;
  onProjectNameChange?: (name: string) => void; // Add new prop for project name change
}
...
export const EditorHeader = ({ 
  ...
  const [showProjectSettings, setShowProjectSettings] = useState(false); // State for project settings popup
  ...
  return (
    <>
      ...
      <ProjectSettingsPopup
        ...
        onProjectNameChange={(name) => onProjectNameChange && onProjectNameChange(name)}
      />
    </>
  );
};